...
import { changeMax, changeCurrent, changeRegen, reduceHealth, addHealth } from '../slices/healthSlice'
  ...
  return (
    <Menu visibility={props.visibility ? 'flex' : 'none'} >
        <Form>
            <label>
                Max
                <input name="max" type='number' value={health.max} onChange={onChange} />
            </label>
            <label>
                Cur
                <input name="cur" type='number' value={health.current} onChange={onChange} />
            </label>
            <label>
                /Rnd
                <input name="rnd" type='number' value={health.regen} onChange={onChange} />
            </label>
        </Form>
        <ChangeForm>
            <input type="number" onChange={updateHealthToChange} value={healthToChange} placeholder="0" />
